...
public class Algoritmos {
    ...
    public static SistemaPlanetario ubicarSistemaPlanetarioPorNombre(String nombre){
        if(!nombre.equals("")){
            for(Nebulosa nebulosa: viaLactea.getLista_nebulosas()){
                for(SistemaPlanetario sistema : nebulosa.getLista_sistemas_planetarios()){
                    if(sistema.getNombre().equalsIgnoreCase(nombre)){
                        return sistema;
                    }
                }
            }
